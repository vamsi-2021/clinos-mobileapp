...
import BotSvg from '../../assets/images/bot.svg';
...
import CircleXMarkSvg from '../../assets/images/circle_x_mark.svg';
...
import DefenceSvg from '../../assets/images/defence.svg';
...
export const BotIcon            = wrap(BotSvg);
...
export const CircleXMarkIcon    = wrap(CircleXMarkSvg);
...
export const DefenceIcon        = wrap(DefenceSvg);
...
export const SendIcon           = wrap(SendSvg);
